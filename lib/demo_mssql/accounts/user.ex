defmodule DemoMssql.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, DemoMssql.Repo)
  ...
  """
  def valid_password?(%DemoMssql.Accounts.User{hashed_password: hashed_password}, password)
